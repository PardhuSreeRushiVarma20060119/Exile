...
exile - program to do something

# SYNOPSIS

**exile** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**exile** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **exile** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**exile** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    exile. See **foo.conf**(5) for further details.
...
**exile** provides some return codes, that can be used in scripts:
...
zenrage-a1105 <zenrage-a1105@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 zenrage-a1105
